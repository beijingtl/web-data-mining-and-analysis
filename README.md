...
- 第一篇 认知篇1
- 第1章 科学认识网站数据分析1
- 1.1 企业为什么要对网站数据进行分析1
- 1.1.1网站数据分析能为“谁”解决问题1
- 1.1.2网站数据分析能解决哪些问题2
- 1.1.3常见的几种“分析”概念5
- 1.2 网站数据分析的5个误区7
- 1.3 识别网站数据欺骗的3种形态11
...
- 第5章 网站分析工具的选择102
- 5.1 网站分析工具102
- 5.1.1 Adobe Analytics104
- 5.1.2 Webtrekk124
- 5.1.3 Webtrends131
- 5.1.4 Google Analytics134
- 5.1.5 IBM Coremetrics143
- 5.1.6 Piwik147
- 5.1.7 百度统计149
- 5.2 移动分析工具150
- 5.2.1 Flurry151
...
- 7.4 本章小结254
- 第8章 数据分析场景和方法255
- 8.1 以效果预测为目的的数据分析255
- 8.1.1效果预测是什么255
- 8.1.2效果预测的2种类型255
- 8.1.3效果预测的应用场景257
- 8.1.4预测结果的常用方法257
- 8.2 以结论定义为目的的数据分析268
- 8.2.1结论定义是什么268
- 8.2.2结论定义的4种方向269
- 8.2.3结论定义的3个误区270
- 8.2.4下定结论的常用方法273
- 8.3 以数据探究为目的的数据分析276
- 8.3.1数据探究是什么276
- 8.3.2数据探究的2种类型276
- 8.3.3探究原因的分析方法277
- 8.4 以业务执行为目的的数据分析282
- 8.4.1业务执行是什么282
- 8.4.2业务执行的2种类型283
- 8.4.3提取业务执行建议的常用方法283
- 8.5 正确的数据模型与算法选择观291
- 8.6 本章小结292
- 第三篇 案例篇294
- 第9章 网站数据的营销辅助应用294
- 9.1 网站营销分析辅助报告矩阵294
- 9.2 三种常用的网站营销分析场景303
- 9.2.1营销前的媒体规划与效果预测303
- 9.2.2营销时的异常检测与及时反馈304
- 9.2.3营销后的结果总结与项目分析308
- 9.3 常用的网站营销分析维度310
- 9.3.1目标端310
- 9.3.2媒体端310
- 9.3.3用户端314
...
- 10.4.4 应用层384
- 10.5 个性化媒体投放的实现386
- 10.5.1个性化媒体投放的实现方式386
- 10.5.2如何选择优秀的服务提供商386
- 10.6 个性化媒体投放的问题387
- 10.7 本章小结389
- 第11章 网站数据的运营辅助应用390
- 11.1网站运营分析辅助报告矩阵390
- 11.2三类常见的网站运营分析场景390
- 11.2.1点：面向单体坑位的辅助分析391
- 11.2.2线：面向站内流程的优化与提高394
- 11.2.3面：面向整体网站资源的价值最大化400
- 11.3常用的网站运营分析维度402
- 11.3.1目标端402
- 11.3.2运营端402
- 11.3.3用户端404
...
- 11.3.6其他因素408
- 11.4网站运营辅助决策四大案例409
- 11.4.1站内广告位效果标杆管理410
- 11.4.2网站用户调研414
- 11.4.3站内活动分析424
- 11.4.4商品销售诊断443
- 11.5本章小结452
- 第12章 数据驱动下的个性化运营应用454
- 12.1 网站运营的概念和范围454
- 12.2 网站运营发展的三种形态454
- 12.3 个性化网站运营的价值455
- 12.4 个性化网站运营的应用456
...
- 15.4 本章小结511
- 第16章 数据流程与落地管理513
- 16.1 数据流程与落地管理的内涵513
- 16.2 数据流程与落地管理的意义514
- 16.3 数据流程与落地管理的策略515
- 16.4 数据流程与落地管理的框架518
- 16.4.1数据需求管理518
- 16.4.2项目工作流程521
- 16.4.3数据培训体系524
- 16.4.4权限管理流程526
